...
const loginUsers = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = jwt_Helpers_1.jwtHelpers.createToken({ _id, usermail }, Config_1.default.jwt.secret, Config_1.default.jwt.expires_in);
    const refreshToken = jwt_Helpers_1.jwtHelpers.createToken({ _id, usermail }, Config_1.default.jwt.refresh_secret, Config_1.default.jwt.refresh_expires_in);
    return {
        accessToken,
        refreshToken,
...
const refreshToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // generate new token
    const newAccessToken = jwt_Helpers_1.jwtHelpers.createToken({ id: isUserExist._id }, Config_1.default.jwt.secret, Config_1.default.jwt.expires_in);
    return {
